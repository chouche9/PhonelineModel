...
from test_data import jan_data, com_data, loc_data, filter_data
...
def test_customer_creation_complex() -> None:
    """ Test for the correct creation of Customer, PhoneLine, and Contract
    classes with a more complex list of calls and customers
    """
    customers = create_customers(com_data)
